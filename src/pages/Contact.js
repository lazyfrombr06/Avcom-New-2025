...
const Contact = () => {
  useDocTitle("ANT - Send us a message");
  const [firstName, setFirstName] = useState("");
  const [lastName, setLastName] = useState("");
  const [email, setEmail] = useState("");
  const [phone, setPhone] = useState("");
  ...
  const sendEmail = (e) => {
    ...
    const templateParams = {
      ...
      phone_number: phone,
      message: message,
      to_name: 'Avcom Nework Technologies'
    };


    const serviceId = process.env.REACT_APP_SERVICE_ID_FOR_CONTACT;
    const templateId = process.env.REACT_APP_TEMPLATE_ID_FOR_CONTACT;
    const publicKey = process.env.REACT_APP_PUBLIC_KEY_FOR_CONTACT;
    ...
    emailjs.send(serviceId, templateId, templateParams,publicKey).then(
      (response) => {
        ...
        clearInput();
        setSubmitStatus(
          "Thanks for your message... we will get back to you very shortly"
        );
            ...
            <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
              ...
              <div className="my-2 w-1/2 lg:w-2/4">
                <button
                  type="submit"
                  id="submitBtn"
                  className="uppercase text-sm font-bold tracking-wide bg-blue-900 hover:bg-blue-700 text-gray-100 p-3 rounded-lg w-full 
                                    focus:outline-none focus:shadow-outline"
                >
                  Send Message
                </button>
          ...
          <div className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-blue-900 rounded-2xl">
            <div className="flex flex-col text-white">
              <div className="flex my-4 w-2/3 lg:w-3/4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">
                    Shiv mandir marg, Badli,<br /> near pancham sweets <br /> 110017, India
                  </p>
                </div>
              </div>
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  <h2 className="text-2xl">Call Us</h2>
                  <p className="text-gray-400">Tel: +91 99111 89318</p>

                  <div className="mt-5">
                    <h2 className="text-2xl">Send an E-mail</h2>
                    <p className="text-gray-400">avcomnetworktechnologies@gmail.com
                    </p>
                  </div>
                </div>
              </div>
