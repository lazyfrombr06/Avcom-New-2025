                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        ...
                        Avcom Network Technologies
                            ...
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">We are one of the leading IT solutions company in Delhi/NCR, specialize in providing complete end to end solutions in Computers, Networking, Software, IT and Solar Lighting systems. </div>
